...
public class NonROSPath {
    ...
    @UserFunction
    @Description("apoc.cfgPath.nonRosFindPaths(start, [settings])")
    public List<Path> nonRosFindPaths(@Name("start") Object start, @Name("config") Map<String,Object> config) {
