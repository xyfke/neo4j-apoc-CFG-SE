...
This function returns a dataflow path from the `start` variable to the `end` variable using a BFS (Breath First Search) cfg feasibility embedded algorithm. More details can be seen in the Dataflow file.
