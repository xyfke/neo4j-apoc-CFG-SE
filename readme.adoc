...
The description of the CFG validation functions are in https://github.com/xyfke/neo4j-apoc-CFG-SE/blob/4.4/Dataflow_Function.md[Dataflow_Function.md] file.
