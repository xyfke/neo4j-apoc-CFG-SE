...
In our forked version of APOC, we included a new file https://github.com/xyfke/neo4j-apoc-CFG-SE/blob/4.4/core/src/main/java/apoc/path/DataflowPath.java[/core/src/main/java/apoc/path/Dataflow.java] to help construct the dataflow paths in behaviour alteration and publisher alteration queries. Specifically, it verifies the feasibility of the paths using a CFG-based verification. 
